...
def attack(char_name: str, char_class: str) -> str:
    """Функция отвечает за способность атаковать противника."""
    ...
    return 'Не удалось нанести урон'


def defence(char_name: str, char_class: str) -> str:
    """Функция отвечает за способность защищаться от противника."""
    if char_class == 'warrior':
    ...
    return 'Не удалось использовать защиту'


def special(char_name: str, char_class: str) -> str:
    """Функция отвечает за ульту."""
    if char_class == 'warrior':
        return (
    ...
    return 'Не удалось использовать ульту'
